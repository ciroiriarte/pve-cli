...
func init() {
	...
	reg("auto-install installations delete", "DELETE", "/auto-install/installations/{uuid}")
	reg("auto-install prepared delete", "DELETE", "/auto-install/prepared/{id}")
	reg("auto-install tokens delete", "DELETE", "/auto-install/tokens/{id}")
	...
	// Tier 2 PVE curation (v0.10.0)
	// SDN (PVE /cluster/sdn)
	reg("sdn apply", "PUT", "/cluster/sdn")
	reg("sdn zone list", "GET", "/cluster/sdn/zones")
	reg("sdn zone create", "POST", "/cluster/sdn/zones")
	reg("sdn zone show", "GET", "/cluster/sdn/zones/{zone}")
	reg("sdn zone delete", "DELETE", "/cluster/sdn/zones/{zone}")
	reg("sdn vnet list", "GET", "/cluster/sdn/vnets")
	reg("sdn vnet create", "POST", "/cluster/sdn/vnets")
	reg("sdn vnet show", "GET", "/cluster/sdn/vnets/{vnet}")
	reg("sdn vnet delete", "DELETE", "/cluster/sdn/vnets/{vnet}")
	reg("sdn subnet list", "GET", "/cluster/sdn/vnets/{vnet}/subnets")
	reg("sdn subnet create", "POST", "/cluster/sdn/vnets/{vnet}/subnets")
	reg("sdn subnet delete", "DELETE", "/cluster/sdn/vnets/{vnet}/subnets/{subnet}")
	reg("sdn controller list", "GET", "/cluster/sdn/controllers")
	reg("sdn controller create", "POST", "/cluster/sdn/controllers")
	reg("sdn controller show", "GET", "/cluster/sdn/controllers/{controller}")
	reg("sdn controller delete", "DELETE", "/cluster/sdn/controllers/{controller}")
	reg("sdn ipams", "GET", "/cluster/sdn/ipams")
	reg("sdn dns", "GET", "/cluster/sdn/dns")
	// firewall — cluster scope
	reg("firewall rules", "GET", "/cluster/firewall/rules")
	reg("firewall rule add", "POST", "/cluster/firewall/rules")
	reg("firewall rule delete", "DELETE", "/cluster/firewall/rules/{pos}")
	reg("firewall aliases", "GET", "/cluster/firewall/aliases")
	reg("firewall ipset", "GET", "/cluster/firewall/ipset")
	reg("firewall options", "GET", "/cluster/firewall/options")
	reg("firewall groups", "GET", "/cluster/firewall/groups")
	reg("firewall macros", "GET", "/cluster/firewall/macros")
	// firewall — node scope
	reg("firewall rules --node", "GET", "/nodes/{node}/firewall/rules")
	reg("firewall rule add --node", "POST", "/nodes/{node}/firewall/rules")
	reg("firewall rule delete --node", "DELETE", "/nodes/{node}/firewall/rules/{pos}")
	reg("firewall aliases --node", "GET", "/nodes/{node}/firewall/aliases")
	reg("firewall ipset --node", "GET", "/nodes/{node}/firewall/ipset")
	reg("firewall options --node", "GET", "/nodes/{node}/firewall/options")
	// firewall — guest scope (vm + ct)
	regGuest("firewall rules", "GET", "/firewall/rules")
	regGuest("firewall rule add", "POST", "/firewall/rules")
	regGuest("firewall rule delete", "DELETE", "/firewall/rules/{pos}")
	regGuest("firewall aliases", "GET", "/firewall/aliases")
	regGuest("firewall ipset", "GET", "/firewall/ipset")
	// firewall options (guest) already curated in Tier 1
	// Ceph management (PVE node-scoped)
	reg("ceph health", "GET", "/nodes/{node}/ceph/status")
	reg("ceph osd list", "GET", "/nodes/{node}/ceph/osd")
	reg("ceph osd in", "POST", "/nodes/{node}/ceph/osd/{osdid}/in")
	reg("ceph osd out", "POST", "/nodes/{node}/ceph/osd/{osdid}/out")
	reg("ceph osd scrub", "POST", "/nodes/{node}/ceph/osd/{osdid}/scrub")
	reg("ceph osd destroy", "DELETE", "/nodes/{node}/ceph/osd/{osdid}")
	reg("ceph pool list", "GET", "/nodes/{node}/ceph/pool")
	reg("ceph pool create", "POST", "/nodes/{node}/ceph/pool")
	reg("ceph pool delete", "DELETE", "/nodes/{node}/ceph/pool/{name}")
	for _, st := range []string{"start", "stop", "restart"} {
		reg("ceph service "+st, "POST", "/nodes/{node}/ceph/"+st)
	}
	reg("ceph config", "GET", "/nodes/{node}/ceph/cfg/raw")
}
